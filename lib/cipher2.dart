...
class GcmResult {
  ...
  GcmResult({this.result, this.tag});

  factory GcmResult.fromMap(Map<String, dynamic> map) {
    return GcmResult(result: map["data"], tag: map["tag"]);
  }
}
...
class Cipher2 {
  ...
  static Future<GcmResult> encryptAesGcm128(
      String plainText, String key, String nonce) async {
    final res = await _channel.invokeMethod("Encrypt_AesGcm128", {
      "data": plainText,
      "key": key,
      "nonce": nonce,
    });

    return GcmResult.fromMap(json.decode(res));
  }
